...
// and the rest of the app is unaffected. NotificationInput.body is plain text;
// any HTML-rendering adapter must escape interpolated applicant values (names,
// messages) before placing them in markup.
