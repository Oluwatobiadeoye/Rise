  ...
  gallery: [
    {
      ...
      photos: [
        { src: aatan01, alt: "Students seated as a facilitator leads a session at Aatan Baptist Comprehensive School, 2019." },
        { src: aatan02, alt: "A facilitator addressing the room at the 2019 bootcamp, Aatan Baptist Comprehensive School." },
        { src: aatan03, alt: "A facilitator presenting at the front of the class, Aatan Baptist Comprehensive School, 2019." },
        { src: aatan04, alt: "Students listening during a session at Aatan Baptist Comprehensive School, 2019." },
        { src: aatan05, alt: "A facilitator standing among seated students at the 2019 bootcamp, Aatan Baptist Comprehensive School." },
        { src: aatan06, alt: "Students engaged during the 2019 bootcamp at Aatan Baptist Comprehensive School." },
        { src: aatan07, alt: "Students seated during a session at Aatan Baptist Comprehensive School, 2019." },
        { src: aatan08, alt: "A facilitator speaking with a student at the front of the hall, Aatan Baptist Comprehensive School, 2019." },
        { src: aatan09, alt: "A facilitator working with a student at Aatan Baptist Comprehensive School, 2019." },
        { src: aatan10, alt: "A group photo of students and facilitators at Aatan Baptist Comprehensive School, 2019." },
        { src: aatan11, alt: "A student listening during a session at Aatan Baptist Comprehensive School, 2019." },
        { src: aatan12, alt: "Facilitators presenting Sustainable Development Goals cards at Aatan Baptist Comprehensive School, 2019." },
      ],
    },
    {
